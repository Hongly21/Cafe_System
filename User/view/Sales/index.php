...
$sqlid = "SELECT * FROM employees WHERE Name='$username'";
...
<body>
    ...
    <div class="container mt-3">
        ...
        <!-- Search -->
        <h2 class="text-center fw-bold">MENU TAB ALL PRODUCT</h2>
        <!-- menu tab -->
        <section class="container py-5 menu-section">
            <input id="searchInput" type="text" class="form-control mb-3" placeholder="Search items...">
                                ...
                                <div class="col">
                                    <div class="card product-card p-2 drink-item">
                                        <img data-bs-toggle="modal" data-bs-target="#itemModal"
                                            ...
                                            src="../../../Cafe_System/assets/images/<?php echo $row2['Image'] ?>"
                                            style="object-fit: contain; width: 170px; height: 200px;"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <button class="btn btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#showqr">QRCode</button>
                    <input type="hidden" id="usernameseller" value="<?php echo $username; ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.btncloseqr').click(function() {
            ...
            let cashier = $('#usernameseller').val();
            let date = new Date();
        ...
        $('.product-img').click(function() {
            ...
            $('#ImagePreview').attr('src', '../../../Cafe_System/assets/images/' + image);
